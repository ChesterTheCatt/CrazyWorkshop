...
public class DiamondStickItem extends CrazyrandomthingsModElements.ModElement {
	@ObjectHolder("crazyrandomthings:diamond_stick")
	public static final Item block = null;

	public DiamondStickItem(CrazyrandomthingsModElements instance) {
		super(instance, 42);
	}
