...
public class BulletTFItem extends CrazyrandomthingsModElements.ModElement {
	@ObjectHolder("crazyrandomthings:bullet_tf")
	public static final Item block = null;

	public BulletTFItem(CrazyrandomthingsModElements instance) {
		super(instance, 74);
	}
