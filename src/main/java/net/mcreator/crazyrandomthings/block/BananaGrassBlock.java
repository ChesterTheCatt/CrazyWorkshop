...
public class BananaGrassBlock extends CrazyrandomthingsModElements.ModElement {
	@ObjectHolder("crazyrandomthings:banana_grass")
	public static final Block block = null;

	public BananaGrassBlock(CrazyrandomthingsModElements instance) {
		super(instance, 50);
	}
